# THIS IS A MODIFIED - BUT UP TO DATE - VERSION OF THE ORIGINAL LIBRARY
# ALL THE CREDITS GOES TO THE ORIGINAL AUTHOR

# Arduino Joystick Library
#### Version 2.0.5u (custom unsigned version) (eg. Unity compatible)
